...
func (r *ChangeStreamReceiver) Connect(clients *client.Clients) error {
...
func (r *ChangeStreamReceiver) Read() (client.Message, func() error, error) {
...
func (r *ChangeStreamReceiver) transform(doc bson.Raw) (client.Message, error) {
...
var (
	_ client.Receiver = (*ChangeStreamReceiver)(nil)
)
