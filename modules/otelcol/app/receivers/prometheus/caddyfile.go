...
func (p *PrometheusReceiver) UnmarshalCaddyfile(d *caddyfile.Dispenser) error {
	if err := parser.ExpectString(d, parser.Match("prometheus")); err != nil {
		return err
	}
	...
	for nesting := d.Nesting(); d.NextBlock(nesting); {
		...
		case "query_log_file":
			if err := parser.ParseString(d, &p.Config.GlobalConfig.QueryLogFile); err != nil {
				return err
			}
		case "external_labels":
			...
			if err := parser.ParseStringMap(d, &labels); err != nil {
				return err
			}
		...
		case "sample_limit":
			if err := parser.ParseUint(d, &p.Config.GlobalConfig.SampleLimit); err != nil {
				return err
			}
		case "target_limit":
			if err := parser.ParseUint(d, &p.Config.GlobalConfig.TargetLimit); err != nil {
				return err
			}
		case "label_limit":
			if err := parser.ParseUint(d, &p.Config.GlobalConfig.LabelLimit); err != nil {
				return err
			}
		case "label_name_lengh_limit":
			if err := parser.ParseUint(d, &p.Config.GlobalConfig.LabelNameLengthLimit); err != nil {
				return err
			}
		case "label_value_lengh_limit":
			if err := parser.ParseUint(d, &p.Config.GlobalConfig.LabelValueLengthLimit); err != nil {
				return err
			}
		case "keep_dropped_targets":
			if err := parser.ParseUint(d, &p.Config.GlobalConfig.KeepDroppedTargets); err != nil {
				return err
			}
		case "scrape_config":
		...
		case "scrape_config_file":
			...
			if err := parser.ParseStringArray(d, &p.Config.ScrapeConfigFiles); err != nil {
				return err
			}
		default:
...
func parseScrapeConfig(d *caddyfile.Dispenser, cfgs *[]*pconfig.ScrapeConfig) error {
	...
	if d.CountRemainingArgs() > 0 {
		...
		err := parser.ParseString(d, &cfg.JobName)
		if err != nil {
			return err
		}
		if cfg.JobName == "" {
		...
		err = parser.ParseStringArray(d, &staticCfg.Targets, parser.AllowEmpty())
		if err != nil {
			return err
		}
	...
	for nesting := d.Nesting(); d.NextBlock(nesting); {
		switch d.Val() {
		case "job_name":
			if err := parser.ParseString(d, &cfg.JobName); err != nil {
				return err
			}
		case "honor_labels":
			if err := parser.ParseBool(d, &cfg.HonorLabels); err != nil {
				return err
			}
		case "honor_timestamps":
			if err := parser.ParseBool(d, &cfg.HonorTimestamps); err != nil {
				return err
			}
		case "params":
			cfg.Params = fnutils.DefaultIfEmptyMap(cfg.Params, url.Values{})
			var values map[string][]string
			if err := parser.ParseStringArrayMap(d, &values); err != nil {
				return err
			}
		...
		case "scrape_classic_histograms":
			if err := parser.ParseBool(d, &cfg.ScrapeClassicHistograms); err != nil {
				return err
			}
		case "metrics_path":
			if err := parser.ParseString(d, &cfg.MetricsPath); err != nil {
				return err
			}
		case "scheme":
			if err := parser.ParseString(d, &cfg.Scheme); err != nil {
				return err
			}
		case "body_size_limit":
		...
		case "target_limit":
			if err := parser.ParseUint(d, &cfg.TargetLimit); err != nil {
				return err
			}
		case "label_limit":
			if err := parser.ParseUint(d, &cfg.LabelLimit); err != nil {
				return err
			}
		case "label_name_lengh_limit":
			if err := parser.ParseUint(d, &cfg.LabelNameLengthLimit); err != nil {
				return err
			}
		case "label_value_lengh_limit":
			if err := parser.ParseUint(d, &cfg.LabelValueLengthLimit); err != nil {
				return err
			}
		case "native_histogram_bucket_limit":
			if err := parser.ParseUint(d, &cfg.NativeHistogramBucketLimit); err != nil {
				return err
			}
		case "keep_dropped_targets":
			if err := parser.ParseUint(d, &cfg.KeepDroppedTargets); err != nil {
				return err
			}
		case "basic_auth":
			...
			for nesting := d.Nesting(); d.NextBlock(nesting); {
				switch d.Val() {
				case "username":
					if err := parser.ParseString(d, &cfg.HTTPClientConfig.BasicAuth.Username); err != nil {
						return err
					}
				case "password":
					var secret string
					if err := parser.ParseString(d, &secret); err != nil {
						return err
					}
					cfg.HTTPClientConfig.BasicAuth.Password = config.Secret(secret)
				case "password_file":
					if err := parser.ParseString(d, &cfg.HTTPClientConfig.BasicAuth.PasswordFile); err != nil {
						return err
					}
				}
			}
		...
		case "bearer_token_file":
			cfg.HTTPClientConfig = fnutils.DefaultIfNil(cfg.HTTPClientConfig, &pconfig.HTTPClientConfig{})
			if err := parser.ParseString(d, &cfg.HTTPClientConfig.BearerTokenFile); err != nil {
				return err
			}
		case "authorization":
			cfg.HTTPClientConfig = fnutils.DefaultIfNil(cfg.HTTPClientConfig, &pconfig.HTTPClientConfig{})
			...
			for nesting := d.Nesting(); d.NextBlock(nesting); {
				switch d.Val() {
				case "type":
					if err := parser.ParseString(d, &cfg.HTTPClientConfig.Authorization.Type); err != nil {
						return err
					}
				case "credentials":
					var secret string
				...
				case "credentials_file":
					if err := parser.ParseString(d, &cfg.HTTPClientConfig.Authorization.CredentialsFile); err != nil {
						return err
					}
				}
			}
		case "oauth2":
			...
			for nesting := d.Nesting(); d.NextBlock(nesting); {
				switch d.Val() {
				case "client_id":
					if err := parser.ParseString(d, &cfg.HTTPClientConfig.OAuth2.ClientID); err != nil {
						return err
					}
				case "client_secret":
					var secret string
				...
				case "client_secret_file":
					if err := parser.ParseString(d, &cfg.HTTPClientConfig.OAuth2.ClientSecretFile); err != nil {
						return err
					}
				case "scope", "scopes":
					cfg.HTTPClientConfig.OAuth2.Scopes = fnutils.DefaultIfEmpty(cfg.HTTPClientConfig.OAuth2.Scopes, []string{})
					if err := parser.ParseStringArray(d, &cfg.HTTPClientConfig.OAuth2.Scopes); err != nil {
						return err
					}
				case "token_url":
					if err := parser.ParseString(d, &cfg.HTTPClientConfig.OAuth2.TokenURL); err != nil {
						return err
					}
				case "endpoint_parans":
					...
					if err := parser.ParseStringMap(d, &cfg.HTTPClientConfig.OAuth2.EndpointParams); err != nil {
						return err
					}
				default:
		...
		case "follow_redirects":
			cfg.HTTPClientConfig = fnutils.DefaultIfNil(cfg.HTTPClientConfig, &pconfig.HTTPClientConfig{})
			if err := parser.ParseBool(d, &cfg.HTTPClientConfig.FollowRedirects); err != nil {
				return err
			}
		case "enable_http2":
			cfg.HTTPClientConfig = fnutils.DefaultIfNil(cfg.HTTPClientConfig, &pconfig.HTTPClientConfig{})
			if err := parser.ParseBool(d, &cfg.HTTPClientConfig.EnableHTTP2); err != nil {
				return err
			}
		default:
			return d.Errf("unrecognized subdirective %s", d.Val())
...
func parseModelDuration(d *caddyfile.Dispenser, dest *model.Duration) error {
	...
	if err := parser.ParseDuration(d, &dur); err != nil {
		return err
	}
